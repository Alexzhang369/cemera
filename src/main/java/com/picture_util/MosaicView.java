...
import com.picture_util.BitmapUtil.Size;
...
public class MosaicView extends ViewGroup {
	...
	private static final int STROKE_COLOR = 0xff000000;
	...
	public void setSrcPath(String absPath) {
		...
		outPath = parent + "/" + System.currentTimeMillis()+fileName;
...
//			canvas.drawBitmap(bmMosaicLayer, 0, 0, null);
			...
			try {
				...
				fos.flush();
				MediaScannerConnection.scanFile(getContext(), new String[]{outPath.toString()}, null, null);
				fos.close();
			} catch (IOException e) {
				e.printStackTrace();

...
public class BitmapUtil {
	...
	public static Bitmap getImage(String absPath) {
		...
		//options.inJustDecodeBounds = true;  这句话返回的图片为空  不传图片
		options.inPurgeable = true;
		options.inSampleSize = 8;// 解决虚拟机内存溢出问题 20160405
		Bitmap bitmap=BitmapFactory.decodeFile(absPath, options); // 解决虚拟机内存溢出问题 20160405
